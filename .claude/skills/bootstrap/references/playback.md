...
| Cross-cutting folders | `People/` flat, no `CLAUDE.md` until it passes roughly fifty notes | A router over ten notes costs more than it routes | A count found in Phase 2 that is already past it |

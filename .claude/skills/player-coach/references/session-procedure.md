...
- Signal observations (what the coach noticed about the user's pattern this session —
  accumulates across sessions so future sessions can detect arcs of improvement,

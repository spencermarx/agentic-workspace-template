...
---
<!-- Vendored from https://github.com/spencermarx/wrkbelt-agent-team (.claude/skills/image-prompt/SKILL.md @ 496d37273aca); adapted for this repo (brand references routed through get-brand-kit rather than inlined; scripts colocated). See [ADR 0002](../../../Decisions/0002-vendor-third-party-skills-as-plain-files.md). -->

...
> move it to `.claude/skills/google-sheets/SKILL.md`, and delete this banner. See
> [README](README.md).

# google-sheets

Read, write, update, and create Google Spreadsheets.
...
Full read and write over Sheets. Useful for trackers and models that a

...
---
<!-- Vendored from https://github.com/spencermarx/wrkbelt-agent-team (.claude/skills/openai/SKILL.md @ 496d37273aca); adapted for this repo (no changes beyond this marker; the skill carried no brand references). See [vendoring provenance](../../../Workspace/Standards/harness-standards.md#vendoring-provenance). -->

...
Based on Garry Tan's [gstack `/office-hours`](https://github.com/garrytan/gstack) —
specifically the Startup mode interrogation and adversarial spec reviewer pattern.
...
specificity. Generic answers ("our users", "improve engagement") are not acceptable —
push for named segments, concrete evidence, and measurable definitions.
